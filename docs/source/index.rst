...
FactFlow accesses the FactSage databases (.cst files) and the user defines the initial conditions including compositions and amounts of the individual streams. When calculating, FactFlow employs the same chemical equilibrium calculation algorithms as
in Equilib.
